...
describe('POST /users', () => {
  it('should create a user', (done) => {
    var email = 'yyy@gmail.com';
    var password = '12344212';
    var nameT = 'Mike';
    request(app)
      .post('/users')
      .send({nameT,email,password})
      .expect(200)
      .expect((res) => {
  ...
  it('should return validation errors if request invalid', (done) => {
    request(app)
      .post('/users')
      .send({name: 'Jack', email: 'aaaagmail.com', password: 'asas'})
      .expect(400)
      .end(done);
  });
  ...
  it('should not create user if email in use', (done) => {
    request(app)
      .post('/users')
      .send({name: 'Jack', email: 'yyy@gmail.com', password: 'asas'})
      .expect(400)
      .end(done);  
  })
});
...
describe('POST /users/login', () => {
  ...
  it('should reject invalid login', (done) => {
    request(app)
      .post('/users/login')
      .send({email: users[1].email, password: users[1].password + 'aaa'})
      .expect(400)
      .expect((res) => {
